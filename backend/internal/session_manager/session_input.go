...
// operation already owns the Operator session. The returned release is idempotent;
...
// that must not independently terminate a session while Operator is replacing or
