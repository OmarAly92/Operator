...
var Builtin = []Command{
	...
	{Name: "cost", Description: "Show the total cost and duration of the current session", Source: SourceBuiltin, Interactive: true},
	...
	{Name: "usage", Description: "Show plan usage limits", Source: SourceBuiltin, Interactive: true},
