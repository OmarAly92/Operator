...
// Deliver but intentionally bypasses input admission. It is only for an Operator
...
// CoordinationUnderMutation writes an Operator coordination message while the caller
...
// Nudge writes an Operator-initiated (unsolicited) message into a live agent. Its
...
// NudgeCoordination writes an Operator-initiated coordination message under the full
