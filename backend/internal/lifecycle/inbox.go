...
// lets the ingest path recognize and drop it.
...
// consumeCoordinationEcho reports whether prompt is the daemon's own last write
// into id, consuming the record so a genuine later repeat of the same text is
// kept.
