...
import (
	...
	workeragent "github.com/OmarAly92/operator/backend/internal/adapters/agent/cursor"
...
// Operator-owned data directory without touching the checkout or user configuration.
...
// Operator-owned system file and then carries the already-short task-file reference.
