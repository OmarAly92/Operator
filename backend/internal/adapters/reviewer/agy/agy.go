// Package agy defines Operator's experimental host-trusted Antigravity reviewer.
package agy
...
import (
	...
	agentagy "github.com/OmarAly92/operator/backend/internal/adapters/agent/agy"
...
// checkout and Operator prompt root are explicitly added because this experimental
...
func (r *Reviewer) ReviewCommand(ctx context.Context, inv ports.ReviewInvocation) (ports.ReviewCommandSpec, error) {
	...
	if err != nil {
		return ports.ReviewCommandSpec{}, fmt.Errorf("agy reviewer: prepare Operator-owned profile: %w", err)
	}
...
// the reviewer command with its Operator-owned profile and current task context.
...
// probing happens after Operator-owned state roots are available in ReviewCommand.
...
// ReviewMessage returns the short Operator-owned task-file reference for a future
