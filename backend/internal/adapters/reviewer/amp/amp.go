// Package amp adapts Amp's normal interactive TUI for Operator reviews.
package amp
...
// ReviewCommand launches Amp's permanent interactive TUI. Operator never uses
...
// reviewer command with the current Operator-owned task context.
