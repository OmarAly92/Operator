// Package droid adapts Factory Droid as an experimental host-trusted Operator
...
import (
	...
	workerdroid "github.com/OmarAly92/operator/backend/internal/adapters/agent/droid"
...
// terminal. Reviewer runs need autonomous execution, so Operator cannot rely on Droid
...
// Operator injects the task after the pane starts and keeps the pane for later passes.
...
// pasted task input before Operator submits the initial review reference.
