...
// changes. It cannot answer "what has this turn changed so far" without Operator
...
// Change kinds Operator reports. These are the neutral names, not the provider's:
