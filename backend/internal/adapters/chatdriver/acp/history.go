...
// message ids are the durable boundaries from which Operator reconstructs settled turns.
...
// establishes the reconstructed turn, then lets SessionUpdate's existing ACP -> Operator
