// Package activitystate holds the standard mapping from an Operator hook sub-command
...
// StandardDeriveActivityState maps a hook sub-command name onto an Operator activity
