...
// command-mode sessions, resuming native sessions by id, installing Operator's
...
// whose events (session-start, stop, permission-request, ...) Operator maps onto
...
func (p *Plugin) GetLaunchCommand(ctx context.Context, cfg ports.LaunchConfig) (cmd []string, err error) {
	...
	// auto-detected by the CLI; prefer inline instructions when Operator has them.
	if cfg.SystemPrompt != "" {
...
// appendApprovalFlags maps Operator's four permission modes onto Autohand's approval
