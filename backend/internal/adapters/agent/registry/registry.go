...
import (
	...
	"github.com/OmarAly92/operator/backend/internal/adapters/agent/agy"
	"github.com/OmarAly92/operator/backend/internal/adapters/agent/aider"
	"github.com/OmarAly92/operator/backend/internal/adapters/agent/amp"
	"github.com/OmarAly92/operator/backend/internal/adapters/agent/auggie"
	"github.com/OmarAly92/operator/backend/internal/adapters/agent/autohand"
	"github.com/OmarAly92/operator/backend/internal/adapters/agent/claudecode"
	"github.com/OmarAly92/operator/backend/internal/adapters/agent/cline"
	"github.com/OmarAly92/operator/backend/internal/adapters/agent/codex"
	"github.com/OmarAly92/operator/backend/internal/adapters/agent/continueagent"
	"github.com/OmarAly92/operator/backend/internal/adapters/agent/copilot"
	"github.com/OmarAly92/operator/backend/internal/adapters/agent/crush"
	"github.com/OmarAly92/operator/backend/internal/adapters/agent/cursor"
	"github.com/OmarAly92/operator/backend/internal/adapters/agent/devin"
	"github.com/OmarAly92/operator/backend/internal/adapters/agent/droid"
	"github.com/OmarAly92/operator/backend/internal/adapters/agent/goose"
	"github.com/OmarAly92/operator/backend/internal/adapters/agent/grok"
	"github.com/OmarAly92/operator/backend/internal/adapters/agent/kilocode"
	"github.com/OmarAly92/operator/backend/internal/adapters/agent/kimchi"
	"github.com/OmarAly92/operator/backend/internal/adapters/agent/kimi"
	"github.com/OmarAly92/operator/backend/internal/adapters/agent/kiro"
	...
	"github.com/OmarAly92/operator/backend/internal/adapters/agent/pi"
	"github.com/OmarAly92/operator/backend/internal/adapters/agent/primeagent"
	"github.com/OmarAly92/operator/backend/internal/adapters/agent/qwen"
	"github.com/OmarAly92/operator/backend/internal/adapters/agent/vibe"
