...
type ingestorStore interface {
	...
	ApplyUsageChunkWithContext(context.Context, int64, int64, time.Time, domain.SourceCursorState, []domain.ModelUsageEvent, *domain.SessionContext, *domain.UsageQuota) error
