...
func TestObserverIntegrationReconcilesRealPtyHostOutputIntoSQLite(t *testing.T) {
...
func waitForTerminalOutput(t *testing.T, runtime *ptyhost.Runtime, handle ports.RuntimeHandle, want string) {
	t.Helper()
