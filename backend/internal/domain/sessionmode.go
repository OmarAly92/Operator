...
//   - SessionModeChat: Operator owns a structured provider controller (Codex
...
// Valid reports whether mode is one Operator knows how to dispatch.
...
// mode Operator cannot honor must fail loudly rather than downgrade.
