...
// unified diff string per turn, which Operator parses. So what these look for is the gap
// between "the agent did work on disk" and "Operator can say what that work was".
...
// the right kind per file. Operator derives all of this by parsing one unified diff string,
