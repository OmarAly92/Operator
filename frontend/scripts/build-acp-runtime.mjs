...
// Release builds run natively on their target OS. This keeps Operator's packaged Node
...
const buildSignature = createHash("sha256")
	...
	.digest("hex");
const markerPath = join(outDir, ".operator-acp-runtime.json");
