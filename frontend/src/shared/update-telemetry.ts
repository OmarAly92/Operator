...
export type UpdateOutcome = {
	event: "opr.renderer.update_failed" | "opr.renderer.update_downloaded" | "opr.renderer.update_unsupported";
	phase: UpdatePhase;
 ...
 *
 * The updater surfaces failures as free-text, so this matches on
