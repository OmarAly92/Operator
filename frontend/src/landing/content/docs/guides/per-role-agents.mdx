...
Compatible Claude Code and Codex sessions expose **Open Chat** or **Open Terminal UI**. Idle sessions switch directly. When work is active, Operator asks whether to finish and drain it or stop and interrupt it before switching controllers.
