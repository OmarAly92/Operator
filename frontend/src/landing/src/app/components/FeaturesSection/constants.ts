...
export const FEATURES: Feature[] = [
  ...
  },
  {
    ...
    description:
      "Operator watches every PR it opens. Failed checks and review comments route back to the session that owns the branch, with the context to fix them, until the PR is approved.",
  ...
  },
  {
    ...
    description:
      "25 harnesses supported, with per-project agent choice. Claude Code, Codex, Cursor, OpenCode, Aider, Goose, and more, Operator keeps it running the way you already run it while the tools underneath evolve.",
  ...
  },
  {
    ...
    description:
      "Pair the Operator mobile app with your desktop over LAN or Tailscale. Watch every session, open a terminal, and get notified when an agent needs you - while execution and code stay on your machine.",
