...
export const themeListings: ThemeListing[] = [
	{
		...
		submittedBy: "tkcel",
		description:
			"A GitHub-inspired dark theme adapted for Operator with strong blue, amber, and green contrast.",
	...
	},
	{
		...
		description: "The Mocha variant from the Catppuccin theme PR for Operator.",
	...
	},
	{
		...
		submittedBy: "tamarazuk",
		description:
			"The Macchiato variant from the Catppuccin theme PR for Operator.",
		addedOn: "March 21, 2026",
		source: {
			label: "Download",
	...
	},
	{
		...
		submittedBy: "tamarazuk",
		description:
			"The Frappé variant from the Catppuccin theme PR for Operator.",
		addedOn: "March 21, 2026",
		source: {
			label: "Download",
	...
	},
	{
		...
		author: "Catppuccin",
		submittedBy: "tamarazuk",
		description: "The Latte variant from the Catppuccin theme PR for Operator.",
		addedOn: "March 21, 2026",
		source: {
			label: "Download",
