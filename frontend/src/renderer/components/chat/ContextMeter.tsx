 ...
 * for a window measured in days on the accounts Operator sees. So the warning arrives
...
/**
 * Normal usage is informational rather than session activity, so it uses Operator's
