 ...
 * both things Operator inserts are plain text the agent has to resolve for itself (a
 ...
 * an undo stack Operator would own, and a11y semantics a textarea gets for free. The
