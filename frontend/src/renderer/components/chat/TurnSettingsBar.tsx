 ...
 *
 * The catalog comes from the provider, not from a list in Operator. Models are added,
 * renamed, hidden per account and gated by entitlement Operator cannot see, so a
...
/**
 * Operator's four approval modes, in increasing order of what the agent may do without
