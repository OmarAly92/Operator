...
// ~/.operator layout or the real daemon/storage.
//
// The on-disk checks (daemon data under ~/.operator, no OS-default app-data
// writes, OPERATOR_DATA_DIR override) are not observable from the renderer.
