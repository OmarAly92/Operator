...
test("the agent-session page exposes the Plan B probes", async () => {
	...
	for (const name of ["feedNextSynced", "rowNodesAdded", "extendSelectionByOneRow", "mountPanes", "cellMetrics", "features", "hoverCell", "clearHover", "hoveredLink", "enablePathLinks", "hintBegin", "hintType", "hintCancel"]) {
