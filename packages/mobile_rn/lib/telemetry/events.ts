...
export const MOBILE_EVENTS = {
	...
	// surface.
	active: "opr.v2.app.active",

	// A brand-new credential was validated by scanning a QR or manual entry. The
	// phone-side confirmation of the daemon's opr.mobile.device_connected.
	paired: "opr.v2.mobile_app.paired",
	// The stored config reconnected on launch (no user pairing action).
	connected: "opr.v2.mobile_app.connected",

	onboardingStarted: "opr.v2.mobile_app.onboarding_started",
	onboardingCompleted: "opr.v2.mobile_app.onboarding_completed",
	onboardingSkipped: "opr.v2.mobile_app.onboarding_skipped",

	// A push notification opened the app. The retention signal.
	notificationOpened: "opr.v2.mobile_app.notification_opened",
	...
	featureUsed: "opr.v2.mobile_app.feature_used",
