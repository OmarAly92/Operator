...
export function ManualConnectSheet({ onConnected }: { onConnected: () => void }) {
		...
		return (
			...
			>
				<SheetHeader
					...
					subtitle="Enter your computer's address from Operator → Settings → Connect Mobile."
				/>
				{form}
			</ScrollView>
		);
	...
	return (
		<SheetScreen title="Connect manually" subtitle="Enter your computer's address from Operator → Settings → Connect Mobile.">
			{form}
		</SheetScreen>
	);
}
