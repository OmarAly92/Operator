...
describe("githubAppUrl", () => {
	it("maps a repo URL", () => {
		expect(githubAppUrl("https://github.com/OmarAly92/operator")).toBe(
			"github://repo/OmarAly92/operator",
		);
	});
	...
	it("refuses the prefilled new-issue URL", () => {
		expect(githubAppUrl("https://github.com/OmarAly92/operator/issues/new?body=hello")).toBeNull();
