	...
	if (!configured) {
		return (
			<View style={styles.screen}>
				...
				<EmptyState icon="share-2" title="No server" message="Connect to Operator in Settings." />
			</View>
		);
	}
				...
				>
					...
					{projects.length === 0 ? (
						error ? (
							...
							<EmptyState icon="folder" title="No projects" message="Add a project in Operator to get started." />
						)
					) : (
						projects.map((p) => {
