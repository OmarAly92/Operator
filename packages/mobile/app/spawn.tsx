	...
	return (
		<KeyboardAvoidingView style={styles.screen} behavior={Platform.OS === "ios" ? "padding" : undefined}>
			<ScrollView contentContainerStyle={{ padding: 16, paddingBottom: 40 }} keyboardShouldPersistTaps="handled">
				...
				{mode === "chat" && !loading && agents.length === 0 ? <Text style={styles.warn}>No installed agent on this Operator host currently supports Chat. Choose Terminal UI or install/authenticate a Chat-capable agent.</Text> : null}
