...
| [todo/tauri-port-bugs-and-deferred.md](todo/tauri-port-bugs-and-deferred.md) | Confirmed Tauri port bugs and deliberately deferred work from the full-port audit. |
