...
- [ ] Branched from `master` (or continuing an existing PR branch)
- [ ] One focused change; links the related issue when applicable
- [ ] Follows [AGENTS.md](https://github.com/OmarAly92/operator/blob/master/AGENTS.md) conventions and PR hygiene
