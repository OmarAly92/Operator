...
- [ ] Branched from `development` and targets `development` (or continuing an existing PR branch)
- [ ] One focused change; links the related issue when applicable
- [ ] Follows [AGENTS.md](https://github.com/OmarAly92/operator/blob/development/AGENTS.md) conventions and PR hygiene
